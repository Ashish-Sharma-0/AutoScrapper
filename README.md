...
```bash
$ pip install git+https://github.com/Rajat3141/AutoScrapper.git
```
...
url = 'https://github.com/Rajat3141/AutoScrapper'

wanted_list = ['A Smart, Automatic, Fast and Lightweight Web Scraper for Python', '2.5k', 'https://github.com/Rajat3141/AutoScrapper/issues']
